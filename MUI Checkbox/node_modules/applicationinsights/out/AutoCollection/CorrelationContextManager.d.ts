...
export declare class CorrelationContextManager {
     ...
     */
    static startOperation(input: sharedFuncTypes.Context | (http.IncomingMessage | sharedFuncTypes.HttpRequest) | SpanContext | Span, request?: sharedFuncTypes.HttpRequest | string): CorrelationContext | null;
    /**
